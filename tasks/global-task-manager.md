...
| T005 | Audio Buffer Sync After Deletion | 1 | 1/2 | CODE_REVIEW | crates/editor/src/audio.rs, crates/editor/src/playback.rs | CLAUDE.md | [main.md](./active/T005-audio-buffer-sync/main.md) |
